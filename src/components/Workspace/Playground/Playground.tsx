...
const Playground: React.FC<PlaygroundProps> = ({ problem, setSuccess, setSolved }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            //converting the code of the user from string to function
                ...
                <Split
                    ...
                    <div className='w-full px-5 overflow-auto'>
                        ...
                        <div className="font-semibold my-4">
                            ...
                            <div className='w-fulll cursor-text rounded-lg border px-3 py-[10px] bg-dark-fill-3 border-transparent text-white mt-2 '>
