            ...
            <div className={`flex w-full items-center justify-between ${!problemPage ? "max-w-[1200px] mx-auto" : ""} `}>
                ...
                {problemPage && (
                    <div className='flex items-center gap-4 flex-1 justify-center '>
                        ...
                        {/* go-to-left-question-button */}
                        <div className='flelx items-center justify-center rounded py-2 px-2 bg-dark-fill-3 hover:bg-dark-fill-2 h-8 w-8 cursor-pointer'
                ...
                <div className='flex items-center space-x-4 flex-1 justify-end'>
                    ...
                    {user && (
                        <div className='cursor-pointer group relative'>
                            <Image src="/avatar.png" alt='Avatar' height={30} width={30} className='rounded-full' />
                            <div
